        ...
        <div class="bg-darkcard border border-gray-800 rounded-xl p-8 shadow-xl">
            <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" class="w-full bg-darkbg border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent" required>
                    @error('name')
