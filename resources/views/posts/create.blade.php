            ...
            <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <select name="category_id" id="category_id" required
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}" class="bg-darkbg text-white" {{ old('category_id') == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="status" id="status" required
                        class="w-full bg-darkbg border border-gray-700 text-white rounded-lg px-4 py-3 focus:outline-none focus:border-accent transition">
                        <option value="draft" class="bg-darkbg text-white" {{ old('status') == 'draft' ? 'selected' : '' }}>Draft</option>
                        <option value="published" class="bg-darkbg text-white" {{ old('status') == 'published' ? 'selected' : '' }}>Published</option>
                    </select>
